# Getting help with pairwiseComparisons

Thanks for using pairwiseComparisons. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/pairwiseComparisons/issues) to make sure the 
