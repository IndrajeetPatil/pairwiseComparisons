...
#> 3 herbi   insecti   1.63   0.102  ns          
#> 4 carni   omni      1.14   0.254  ns          
...
#> 3 list(~italic(p)[ unadjusted ]== 0.102 ) Dunn test    None              
#> 4 list(~italic(p)[ unadjusted ]== 0.254 ) Dunn test    None              
